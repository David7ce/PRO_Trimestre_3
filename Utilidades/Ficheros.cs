...
{
    public static String DirectorioMiProyecto(String nf)
    {
        return $"{Directory.GetCurrentDirectory()}\\..\\..\\..\\{nf}";
    }

    public static String[,] CargarCSV(string nameFile)
    {
        String? line;
        ...
        StreamReader? myfile = new StreamReader(pathFile, System.Text.Encoding.Default);
        if (myfile == null)
